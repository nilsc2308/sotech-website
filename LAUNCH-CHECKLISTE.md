...
| ⚠️ | **Schnell-Check-Rechner (Speicher-Seite)** – Richtwerte: 5 m² je kWp, 950 kWh je kWp und Jahr, Netzstrom 0,35 €/kWh, Einspeisevergütung 7,78 ct/kWh (sotech.de: Feb.–Juli 2026), Eigenverbrauch 30 % ohne / 60 % mit Speicher, 0,38 kg CO₂/kWh. Bitte plausibilisieren | `main.js` Block „Mini-Rechner“ |
...
| ⚠️ | **Planer (Service)** – Phasendauern sind Erfahrungswerte (Beratung 1 Wo, Angebot 2 Wo, Netzbetreiber 6 Wo, Montage 1 Wo, Zähler/IBN 3 Wo, MaStR 4 Wo). Bitte an die Praxis anpassen | `main.js` Block „Planer“ |
...
| ⚠️ | **Referenzkarte** – 13 Punkte aus der Referenzliste (ZG-/Yingli-Anlagen 2009/2010, Wuppertal 1994, Besichtigungsanlage Aachen). Koordinaten für Kundenanlagen sind nur ortsgenau (Ortsmitte), nicht adressgenau. Gern durch neuere Anlagen ergänzen | `referenzen.html`, `refData` |
...
| ✅ | **Mobile Version** | 390 px (iPhone) in Chromium und WebKit, alle 18 Seiten komplett durchgescrollt: kein Querscrollen (scrollWidth = clientWidth), 0 JS-Fehler. Foto-Szene läuft auf dem Handy identisch (kein Sonderweg); Tag/Nacht-Uhr klebt oben; Story-Foto klebt oben; Akkordeon als vertikaler Stapel; Planer als Stapel; Burger ab 1020 px, Vollbild-Menü, Sticky-CTA unten |
| ✅ | **Meta Titles** | Alle 18 Seiten, 27–66 Zeichen (Startseite 71 Zeichen – bewusst, enthält Ort + Alleinstellung; kürzen auf Wunsch), mit Ort/Leistung |
| ✅ | **Meta Descriptions** | Alle Seiten einzeln, 31–155 Zeichen |
| ✅ | **Favicon** | `favicon.svg` (rotes Quadrat, gelber Balken, weißes S) + `apple-touch-icon.png` 180 px |
| ✅ | **Sitemap.xml** | 16 URLs (ohne danke/404), Datum 15.9.2026, Prioritäten gesetzt |
...
| | Punkt | Stand |
|---|---|---|
| ✅ | **Seiten** | 18: index, photovoltaik, speicher, wallbox, service, referenzen, ueber-uns, ratgeber + 3 Artikel, faq, kontakt, danke, 404, impressum, datenschutz, agb (nach Feedback 15.9.: Speicher/Wallbox getrennt, Referenzen eigene Seite, Startseite entschlackt) |
| ✅ | **Aufbau (eigenständig, siehe DESIGN.md)** | 720vh-Foto-Scroll-Through (Regenbogen-Siedlung → Iris → Streifen-Vorhang → Flüssig-Wipe → Kacheln → Zoom-Dive + Blitz), Zahl „1988“ schrumpft in den Text, Akkordeon-Galerie (5 Streifen), Signature: 24-Stunden-Uhr mit Tag/Nacht-Wechsel, Text-Marquee mit Fotos (Tempo folgt dem Scrollen), EEG-Stichtag, Terminwahl-Kacheln + große Telefonnummer. Navigation: nur Logo + Telefon + „Menü“ mit rotem Vollbild-Overlay. Unterseiten: Vollbild-Foto-Header mit Breadcrumb |
| ✅ | **Interaktiv** | Konfigurator mit SVG-Vorschau + Montage-Reportage (Photovoltaik), Schnell-Check-Rechner (Speicher), Checkliste mit Fortschrittsring (Wallbox), Planer mit Start-Kacheln (Service), Referenzkarte mit klickbaren Punkten (Referenzen), FAQ-Akkordeon, Themenwahl im Formular |
| ✅ | **Browser-Test** | Chromium + WebKit (Safari-Engine), 1400 px + 390 px, alle 18 Seiten durchgescrollt: 0 JS-Fehler, 0 fehlgeschlagene Requests, kein Querscrollen |
