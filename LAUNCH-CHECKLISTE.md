...
| ✅ | **Interaktiv** | Konfigurator mit SVG-Vorschau + Montage-Reportage (Photovoltaik), Schnell-Check-Rechner (Speicher), Checkliste mit Fortschrittsring (Wallbox), Zeitplan-Balken zum Ziehen (Service), Referenzkarte mit klickbaren Punkten (Referenzen), FAQ-Akkordeon, Themenwahl im Formular |
